...
class Email_Pytest_Report:
    ...
    def get_test_report_data(self,html_body_flag= True,report_file_path= 'C:/Users/DanielHasid/PycharmProjects/Automation/Tests/pytest_report.html'):
        "get test report data from pytest_report.html or pytest_report.txt or from user provided file"
        if html_body_flag == True and report_file_path == r"C:\Users\DanielHasid\PycharmProjects\Automation\Tests\pytest_report.html":
        ...
        elif html_body_flag == False and report_file_path == r"C:\Users\DanielHasid\PycharmProjects\Automation\Tests\pytest_report.html":
    ...
    def get_attachment(self,attachment_file_path = r"C:/Users/DanielHasid/PycharmProjects/Automation/Tests/pytest_report.html"):
        "Get attachment and attach it to mail"
        if attachment_file_path == r"C:\Users\DanielHasid\PycharmProjects\Automation\Tests":
            #To generate pytest_report.html file use following command e.g. py.test --html = log/pytest_report.html
    ...
    def send_test_report_email(self,html_body_flag = True,attachment_flag = False,report_file_path = 'C:/Users/DanielHasid/PycharmProjects/Automation/Tests/pytest_report.html'):
        ...
        #Send Email
        server = smtplib.SMTP(self.smtp_ssl_host, self.smtp_ssl_port)
